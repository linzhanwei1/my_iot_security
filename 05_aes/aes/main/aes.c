...
uint8_t key[16] = {0x06, 0xa9, 0x21, 0x40, 0x36, 0xb8, 0xa1, 0x5b,
                   0x51, 0x2e, 0x03, 0xd5, 0x34, 0x12, 0x00, 0x06};
uint8_t iv[16] = {0x3d, 0xaf, 0xba, 0x42, 0x9d, 0x9e, 0xb4, 0x30,
...
void cipher(int type) {
  ...
  mbedtls_cipher_update(&ctx, (const unsigned char *)ptx, strlen(ptx), buf,
                        &len);
  olen += len;
